                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-3 form-group">
                            ...
                            <select name="type" required class="form-control form-control-lg">
                                ...
                                <option value="gallery" <?= $pageinfo->pagestyle=="gallery"?'selected="selected"':'' ?> >Gallery Page</option>
                                <option value="services" <?= $pageinfo->pagestyle=="services"?'selected="selected"':'' ?> >Services Page</option>
                                <option value="project" <?= $pageinfo->pagestyle=="project"?'selected="selected"':'' ?> >Project Page</option>
                            </select>
                        </div>
                        <div class="col-12 col-md-3 form-group">
