            ...
            <ul class="navbar-nav header-right">
              ...
              <?php if ($expanded) : ?>
                <li class="dropdown schedule-event-inner">
                  <a href="#" class="btn btn-outline-primary btn-rounded event-btn">
              ...
              <?php else : ?>
                <li class="dropdown schedule-event primary">
                  <a href="#" class="btn btn-primary btn-rounded event-btn">
                    <i class="flaticon-381-layer-1"></i>
                    <span class="d-none d-xl-inline-block">Manage </span> <span class="d-none d-lg-inline-block">Pages(0)</span>
                    <i class="fa fa-caret-right scale3 ml-2 d-none d-sm-inline-block"></i>
                  </a>
    ...
    <div class="deznav">
      <div class="deznav-scroll">
        <ul class="metismenu" id="menu">
          ...
          <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
              <i class="flaticon-381-layer-1"></i>
              <span class="nav-text">Gallery & Slides</span>
            </a>
            <ul aria-expanded="false">
              <li><a href="/admin/slides">Manage Slides</a></li>
              <li><a href="/admin/galleries">Manage Galleries</a></li>
              <li><a href="/admin/add-slide">Create Slide</a></li>
              <li><a href="/admin/add-gallery">Create Gallery</a></li>
            </ul>
          </li>
